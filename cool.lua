...
function Library.new(config)
	...
	Headers.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
	...
	TabButtonFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
	...
	MainTabFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
	...
	function WindowTable:NewTab(cfg)
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			function SectionTable:NewToggle(toggle)
				...
				FunctionToggle.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			function SectionTable:NewTitle(lrm)
				...
				FunctionTitle.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			function SectionTable:NewButton(cfg)
				...
				FunctionButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
			...
			function SectionTable:NewKeybind(ctfx)
				...
				FunctionKeybind.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			function SectionTable:NewSlider(slider)
				...
				FunctionSlider.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			function SectionTable:NewDropdown(drop)
				...
				FunctionDropdown.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
