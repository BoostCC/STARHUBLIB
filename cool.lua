	...
	function WindowTable:NewTab(cfg)
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			function SectionTable:NewToggle(toggle)
				...
				FunctionToggle.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			function SectionTable:NewTitle(lrm)
				...
				FunctionTitle.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			function SectionTable:NewButton(cfg)
				...
				FunctionButton.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
			...
			function SectionTable:NewKeybind(ctfx)
				...
				FunctionKeybind.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			function SectionTable:NewDropdown(drop)
				...
				FunctionDropdown.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
