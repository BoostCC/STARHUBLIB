...
function Library.new(config)
	...
	Headers.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	...
	MainTabFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	...
	function WindowTable:NewTab(cfg)
		...
		Title.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Title.BorderSizePixel = 0
		Title.Position = UDim2.new(0.050000003, 0, 0.5, 0)
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			Twen:Create(Section,TweenInfo1,{BackgroundTransparency = 0.3}):Play();
			...
			function SectionTable:NewToggle(toggle)
				...
				FunctionToggle.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
				...
				Twen:Create(FunctionToggle,TweenInfo1,{BackgroundTransparency = 0.4}):Play();
			...
			function SectionTable:NewTitle(lrm)
				...
				FunctionTitle.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
			...
			function SectionTable:NewButton(cfg)
				...
				FunctionButton.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			function SectionTable:NewKeybind(ctfx)
				...
				FunctionKeybind.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
			...
			function SectionTable:NewSlider(slider)
				...
				FunctionSlider.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
			...
			function SectionTable:NewDropdown(drop)
				...
				FunctionDropdown.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
